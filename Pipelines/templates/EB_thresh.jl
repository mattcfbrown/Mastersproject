...
try #PUC
   #Gets the network
    ...
    tail = :two
    posteriors = empirical_bayes(test_statistics, prior_list, num_bins, :Normal, proportion_to_keep = proportion_to_keep, tail = tail, w0 = w0)
   ...
   proportion_to_keep = to_keep
   tail = :two
   posteriors = empirical_bayes(test_statistics, prior_list, num_bins, :Gamma, proportion_to_keep = proportion_to_keep, tail = tail, w0 = w0)
